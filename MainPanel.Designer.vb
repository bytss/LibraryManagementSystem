...
Partial Class MainPanel
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(MainPanel))
        ...
        Guna2ControlBox1.Location = New Point(1228, 21)
        Guna2ControlBox1.Margin = New Padding(4, 3, 4, 3)
        Guna2ControlBox1.Name = "Guna2ControlBox1"
        Guna2ControlBox1.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        Guna2ControlBox1.Size = New Size(20, 21)
        ...
        Guna2CirclePictureBox2.Location = New Point(27, 15)
        ...
        Guna2CirclePictureBox2.Size = New Size(40, 36)
        ...
        btn_Dashboard.Size = New Size(209, 57)
        ...
        ' btn_logout
        ' 
        btn_logout.Animated = True
        btn_logout.CustomizableEdges = CustomizableEdges19
        ...
        btn_logout.Location = New Point(4, 570)
        btn_logout.Margin = New Padding(4, 3, 4, 3)
        btn_logout.Name = "btn_logout"
        btn_logout.ShadowDecoration.CustomizableEdges = CustomizableEdges20
        btn_logout.Size = New Size(209, 57)
        btn_logout.TabIndex = 7
        btn_logout.Text = "Logout"
        btn_logout.TextAlign = HorizontalAlignment.Left
        btn_logout.TextOffset = New Point(10, 0)
        ' 
        ' btn_manageuser
        ' 
        btn_manageuser.Animated = True
        btn_manageuser.CustomizableEdges = CustomizableEdges21
        btn_manageuser.DisabledState.BorderColor = Color.DarkGray
        btn_manageuser.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        btn_manageuser.TextOffset = New Point(10, 0)
        ' 
        ' Panel1
        ' 
