...
Partial Class formManagePatron
    ...
    Private Sub InitializeComponent()
        ...
        tbLastName.Location = New Point(222, 124)
        ...
        tbPatronAddress.Location = New Point(32, 519)
        ...
        tbPatronEmail.Location = New Point(32, 462)
        ...
        Label2.Location = New Point(32, 431)
        Label2.Name = "Label2"
        ...
        tbMiddlename.Location = New Point(222, 172)
        ...
        tbFirstName.Location = New Point(221, 220)
        ...
        ' radioVerified
        ' 
        radioVerified.AutoSize = True
        radioVerified.Location = New Point(113, 23)
        radioVerified.Name = "radioVerified"
        radioVerified.Size = New Size(44, 19)
        radioVerified.TabIndex = 62
        radioVerified.TabStop = True
        radioVerified.Text = "YES"
        radioVerified.UseVisualStyleBackColor = True
        ' 
        ' Panel2
        ' 
        ...
        tbPatronContact.Location = New Point(264, 462)
        ...
        tbSchoolId.Location = New Point(32, 370)
        ...
        dgvPatronList.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle2
        dgvPatronList.ColumnHeadersHeight = 35
        dgvPatronList.Columns.AddRange(New DataGridViewColumn() {Column1, Column2, Column3, Column4})
        ...
        dgvPatronList.DefaultCellStyle = DataGridViewCellStyle3
        dgvPatronList.GridColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        dgvPatronList.Location = New Point(539, 172)
        dgvPatronList.Name = "dgvPatronList"
        dgvPatronList.RowHeadersVisible = False
        dgvPatronList.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing
        ...
        dgvPatronList.RowsDefaultCellStyle = DataGridViewCellStyle4
        dgvPatronList.RowTemplate.Height = 25
        dgvPatronList.Size = New Size(509, 485)
        dgvPatronList.TabIndex = 71
        dgvPatronList.ThemeStyle.AlternatingRowsStyle.BackColor = Color.White
        dgvPatronList.ThemeStyle.AlternatingRowsStyle.Font = Nothing
        dgvPatronList.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty
        dgvPatronList.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty
        dgvPatronList.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty
        dgvPatronList.ThemeStyle.BackColor = Color.White
        dgvPatronList.ThemeStyle.GridColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        dgvPatronList.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(CByte(100), CByte(88), CByte(255))
        dgvPatronList.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None
        dgvPatronList.ThemeStyle.HeaderStyle.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        dgvPatronList.ThemeStyle.HeaderStyle.ForeColor = Color.White
        dgvPatronList.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing
        dgvPatronList.ThemeStyle.HeaderStyle.Height = 35
        dgvPatronList.ThemeStyle.ReadOnly = False
        dgvPatronList.ThemeStyle.RowsStyle.BackColor = Color.White
        dgvPatronList.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        dgvPatronList.ThemeStyle.RowsStyle.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        dgvPatronList.ThemeStyle.RowsStyle.ForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        dgvPatronList.ThemeStyle.RowsStyle.Height = 25
        dgvPatronList.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        dgvPatronList.ThemeStyle.RowsStyle.SelectionForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        ' 
        ' Column1
        ' 
        Column1.HeaderText = "#"
        ...
        profilePhoto.Location = New Point(32, 124)
        ...
        CType(dgvPatronList, ComponentModel.ISupportInitialize).EndInit()
